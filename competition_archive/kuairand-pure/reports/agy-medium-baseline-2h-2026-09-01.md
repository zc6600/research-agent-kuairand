# Antigravity `medium` 2h direct baseline

This corrected Antigravity Goal run replaces the older one-hour direct
...
| Metric | Antigravity 2h baseline | Official FM reference | Delta |
|---|---:|---:|---:|
| GAUC | 0.6714473005 | 0.6674 | +0.0040473005 |
| nDCG@5 | 0.5377133445 | 0.5357 | +0.0020133445 |
| **Primary** | **0.6045803225** | **0.6016** | **+0.0029803225** |

The run used `gemini-3.7-flash` through Antigravity 1.1.22, with `medium` effort, and
...
bound to Antigravity's global scratch workspace rather than the requested target.
