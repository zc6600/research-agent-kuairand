# KuaiRand-Pure Research Implementation

## Retained State-Bearing Models

1. **Primary Score-Bearing Model: 46-Field Multi-Seed FM Ensemble** (`system/ensemble_46.py`)
   ...
   - **Reproduction**:
     ```bash
     UV_CACHE_DIR=/private/tmp/research-agent-uv-cache \
