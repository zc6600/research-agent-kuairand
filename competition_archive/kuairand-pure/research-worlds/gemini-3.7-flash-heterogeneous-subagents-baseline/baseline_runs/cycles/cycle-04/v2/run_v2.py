"""Round 04 - Variant v2: Logarithmic Duration Discretization (20 Log Bins in DCN-FM)
10 Fields:
- user_id
- video_id
- author_id
...
def run_experiment(k=16, lr=0.001, l2=1e-6, epochs=20, bs=8192, patience=4, seed=0):
    ...
    history = []
    print("\nStarting DCN_FM training with 20 Log Duration Bins...")
    ...
    results = {
        'variant': 'v2',
        'hypothesis': 'Logarithmic Duration Discretization (20 Log Bins in DCN-FM)',
        'fields': FIELDS,
        'hyperparameters': {
            'k': k,
            'lr': lr,
