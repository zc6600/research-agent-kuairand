"""Round 02 - Variant v2: Expanded Rank Factorization (k=32, L2=1e-6) on 10 Fields
Fields (10 total):
- user_id
- video_id
- author_id
...
Hyperparameters: k=32, lr=0.001, l2=1e-6, batch_size=8192, max_epochs=25, patience=4, seed=0
...
class FM:
    def __init__(self, dim, k=32, lr=0.001, l2=1e-6, seed=0):
...
def run_experiment(k=32, lr=0.001, l2=1e-6, epochs=25, bs=8192, patience=4, seed=0):
    ...
    results = {
        'variant': 'v2',
        'hypothesis': 'Expanded Rank Factorization (k=32, L2=1e-6) on 10 fields',
        'fields': FIELDS,
        'hyperparameters': {
            'k': k,
            'lr': lr,
