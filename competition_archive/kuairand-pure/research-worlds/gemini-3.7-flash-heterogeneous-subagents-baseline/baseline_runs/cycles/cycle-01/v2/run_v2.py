"""Round 01 - Variant v2: User Demographic Extension (10 fields)
Fields:
- user_id
- video_id
- author_id
...
Hyperparameters: k=16, lr=0.001, batch_size=8192, max_epochs=25, patience=4
...
def run_experiment(k=16, lr=0.001, epochs=25, bs=8192, patience=4, seed=0):
    ...
    print(f"\nInitializing FM model (dim={dim}, k={k}, lr={lr}, seed={seed})...")
    ...
    results = {
        'variant': 'v2',
        'hypothesis': 'User Demographic Extension (10 fields)',
        'fields': FIELDS,
        'hyperparameters': {
            'k': k,
            'lr': lr,
