...
def load(data_dir):
    ...
    if os.path.exists(os.path.join(data_dir, 'log_standard_4_22_to_5_08_pure.csv')):
        log_files.append('log_standard_4_22_to_5_08_pure.csv')
    elif os.path.exists(os.path.join(data_dir, 'log_public_4_22_to_4_28_pure.csv')):
        log_files.append('log_public_4_22_to_4_28_pure.csv')
    for f in log_files:
