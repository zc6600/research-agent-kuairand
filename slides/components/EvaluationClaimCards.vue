...
const cards: Card[] = [
  ...
  { id: 'robustness', no: '03', kicker: 'RECOVERY UNDER FAILURE', claim: 'Our agent is robust.', accent: 'var(--rose)', rotate: 0, x: 226, y: 64, scale: 1.1, z: 8, title: 'The research loop recovered when evidence serialization failed.', detail: 'The Scientist repaired the NumPy scalar writer, reran the experiment, and kept the measurements. META then governs what becomes durable State.', meta: 'Cycle 1 · numpy.float32 repair · rerun succeeded · no human intervention' },
  { id: 'comparison', no: '04', kicker: 'DIRECT CODEX CONTROL', claim: 'Our agent outperforms Codex.', accent: 'var(--purple)', rotate: 7, x: 340, y: 39, scale: 1, z: 4, title: 'The retained result is above the recorded direct Codex control.', detail: 'Research Agent reached 0.6059363 Primary; the direct Codex Goal control reached 0.6044533 on public validation. The Codex record remains provisional under its process audit.', meta: '0.6044533 → 0.6059363 · +0.0014830 Primary · public validation' },
  { id: 'tokenmaxxing', no: '05', kicker: 'AUTONOMY AND AUDITABILITY', claim: 'We are not tokenmaxxing.', accent: 'var(--orange)', rotate: 15, x: 452, y: 73, scale: .96, z: 2, title: 'The resource record describes a research process, not a token race.', detail: 'P10 records four cycles, 13 named experiments, zero post-launch manual scientific interventions, 48.24M total tokens, and zero GPU-hours.', meta: '48.240M total · 4.020M non-cache · 0 GPU-hours · 1h 55m 29s' },
]
