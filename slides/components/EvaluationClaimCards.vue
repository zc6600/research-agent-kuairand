...
const cards: Card[] = [
  ...
  { id: 'tokenmaxxing', no: '05', kicker: 'RESOURCE ACCOUNTING', claim: 'We are not tokenmaxxing.', accent: 'var(--orange)', rotate: 15, x: 452, y: 73, scale: .96, z: 2, title: 'Resource use is part of the evidence, not the thesis.', detail: 'The project-level resource story now lives here: ~US$10 subscription-equivalent usage, 48.24M recorded total tokens, 4.02M non-cache input + output, and zero GPU-hours.', meta: '~US$10 project estimate · 48.240M total · 4.020M non-cache · 0 GPU-hours' },
]
