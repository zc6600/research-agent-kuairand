...
const cards: Card[] = [
  ...
  { id: 'comparison', no: '04', kicker: 'DIRECT CODEX CONTROL', claim: 'Our agent beat Codex on this task.', accent: 'var(--purple)', rotate: 7, x: 420, y: 8, scale: .96, z: 4, title: 'The retained result is above the recorded direct Codex control.', detail: 'Research Agent reached 0.6059363 Primary; the direct Codex Goal control reached 0.6044533 on public validation. The original comparison figure is now embedded in this evidence card.', meta: '0.6044533 → 0.6059363 · +0.0014830 Primary · public validation' },
