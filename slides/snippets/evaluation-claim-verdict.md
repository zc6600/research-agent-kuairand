...
Charts, metrics, and prose from Evaluation, Insights, and the appendix are composed directly inside the expanded cards. The following linear slides remain available.
...
- ../README.md — result and evaluation boundary
-->
