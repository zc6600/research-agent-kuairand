...
const requiredFiles = [
  ...
  'exports/current/SciOdyssey-voyage.pdf',
  'exports/current/SciOdyssey-3d.pdf',
...
if (missing.length || !archiveEntries.length || unexpectedRootPdfs.length) {
  ...
  console.log(`OK: ${requiredFiles.length} expected source/export paths, ${archiveEntries.length} archived exports, no unexpected root PDFs.`);
}
