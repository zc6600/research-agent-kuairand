...
<div class="parallel-motion" aria-label="One research world branches into three independent scientists and reconverges at a reviewer.">
  <svg viewBox="0 0 1000 300" role="img" aria-hidden="true">
    ...
    <path class="parallel-branch-progress parallel-auto-rail parallel-progress-a" d="M100 150 C180 150 190 75 300 75 H760" pathLength="1" />
    <path class="parallel-branch-progress parallel-auto-rail parallel-progress-b" d="M100 150 H760" pathLength="1" />
    <path class="parallel-branch-progress parallel-auto-rail parallel-progress-c" d="M100 150 C180 150 190 225 300 225 H760" pathLength="1" />
    ...
    <g class="parallel-card parallel-auto-card parallel-auto-card-a">
      <rect x="350" y="43" width="330" height="64" rx="0" />
      <text x="380" y="82" class="parallel-card-name">Scientist A</text>
      <text x="650" y="82" text-anchor="end" class="parallel-card-branch">r1b1</text>
    </g>
    <g class="parallel-card parallel-auto-card parallel-auto-card-b">
      <rect x="350" y="118" width="330" height="64" rx="0" />
      <text x="380" y="157" class="parallel-card-name">Scientist B</text>
      <text x="650" y="157" text-anchor="end" class="parallel-card-branch">r1b2</text>
    </g>
    <g class="parallel-card parallel-auto-card parallel-auto-card-c">
      <rect x="350" y="193" width="330" height="64" rx="0" />
      <text x="380" y="232" class="parallel-card-name">Scientist C</text>
      <text x="650" y="232" text-anchor="end" class="parallel-card-branch">r1b3</text>
    </g>
    <path v-click="1" class="parallel-merge-progress" d="M760 75 C820 75 830 150 900 150 M760 150 H900 M760 225 C820 225 830 150 900 150" pathLength="1" />
    <g v-click="1" class="parallel-reviewer">
      <circle cx="900" cy="150" r="13" />
      <circle cx="900" cy="150" r="24" />
      <text x="900" y="202" text-anchor="middle">Reviewer</text>
    </g>
  </svg>
</div>
